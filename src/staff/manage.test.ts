  ...
  it("lets Admin create and update 店員 with aliases", async () => {
    ...
    const updated = await updateStaff({
      ...
      data: {
        ...
        title: created.title,
        kind: created.kind,
        guestPeriodKey: created.guestPeriodKey,
        ...
        laborHealthInsuranceMode: created.laborHealthInsuranceMode,
        laborHealthInsuranceRatio: created.laborHealthInsuranceRatio,
        laborHealthInsuranceCarryOverMonthly:
          created.laborHealthInsuranceCarryOverMonthly,
